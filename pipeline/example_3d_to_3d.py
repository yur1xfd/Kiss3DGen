...
if __name__ == "__main__":
    ...
    prompts = open('./examples/enhancement/prompts_a3d_edit.txt', 'r').readlines()

    prompts_dict = {prompt.split(';')[0]: prompt.split(';')[1].strip() for prompt in prompts}
    
    mesh_folder = './examples/enhancement/a3d_meshes'
    for mesh_name in os.listdir(mesh_folder):
        if mesh_name in prompts_dict:
            ...
            print('There is no editing instruction for this mesh')
